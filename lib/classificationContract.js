...
export function classificationWithDefaults(value) {
  return {
    mood: isMood(value?.mood) ? value.mood : DEFAULT_CLASSIFICATION.mood,
    urgency: isUrgency(value?.urgency)
      ? value.urgency
      : DEFAULT_CLASSIFICATION.urgency,
  };
}
